...
//         {
//             await participantService.AddAsync(id, model, includeNotify);
//             return Results.Ok();
//         }).RequireAuthorization("AllUser");

//         app.MapGroup(Constants.ApiRoute_Conversation).MapGet("/{id}/messages",
//         async (IMessageService messageService, Guid id, int page, int limit) =>
//         {
//             var response = await messageService.GetByConversationIdWithPagingAsync(id, page, limit);
//             return Results.Ok(response);
//         }).RequireAuthorization("AllUser");
...
//         async (IConversationService conversationService, Guid id, JsonElement jsonElement) =>
//         {
//             var json = jsonElement.GetRawText();
//             var patch = JsonConvert.DeserializeObject<JsonPatchDocument>(json);
//             var response = await conversationService.PatchAsync(id, patch);
//             return Results.Ok(response);
//         }).RequireAuthorization("AllUser");
//     }
// }