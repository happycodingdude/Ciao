...
public class ConversationService : BaseService<Conversation, ConversationDto>, IConversationService
{
    ...
    public async Task<ConversationDto> CreateAsync(ConversationDto model, bool includeNotify)
    {
        ...
        //         {
        //             to = connection,
        //             data = new CustomNotification<ConversationDto>(AppConstants.NotificationEvent_NewConversation, result)
        //         };
        //         await _notificationService.NotifyAsync<ConversationDto>(AppConstants.NotificationEvent_NewConversation, connection, result);
        //     }
        // }
        return result;
    }
