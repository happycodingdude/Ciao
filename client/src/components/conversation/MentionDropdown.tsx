...
const MentionDropdown = ({
  ...
  <div
    ...
    flex flex-col gap-2 overflow-y-scroll scroll-smooth rounded-[.7rem] bg-(--bg-color) p-2
  ...
  >
    {mentions.length === 0 ? (
      <p className="text-center text-sm text-(--text-main-color-blur)">No members found</p>
    ) : (
