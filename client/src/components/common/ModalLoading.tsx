...
const ModalLoading = (props: { className?: string }) => {
  ...
  return (
    <div className="absolute left-0 top-0 z-10 flex h-full w-full flex-col bg-(--bg-color)">
      <div className="border-(--border-color) border-b-[.1rem] px-4 py-6">
        <div className="wave-line shimmer-effect h-6 w-[30%] rounded-full bg-(--skeleton-base) bg-opacity-40"></div>
      </div>
