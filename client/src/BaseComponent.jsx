...
const BaseComponent = ({ apiEndpoint, httpVerb }) => {
  ...
  useEffect(() => {
    ...
    if (httpVerb !== 'GET') {
      requestOptions = { ...requestOptions, body: JSON.stringify(param.current) };
    }
  ...
  return (
    <SubmissionPage data={tableValue} token={token} />
