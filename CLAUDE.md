...
- Scan ưu tiên: *.sln, *.csproj → Program.cs/Startup.cs → appsettings.json
...
## QUY TRÌNH GIẢI QUYẾT YÊU CẦU VỀ CODING
...
### Bước 4. Trực tiếp viết code, tự động chạy lệnh *dotnet build* đến khi build thành công.

### Bước 5. Sumary các thay đổi và lưu vào docs/TEN_CHUC_NANG_VIET_HOA.md
