...
public class MyMapping : Profile
{
    public MyMapping()
    {
        ...
        CreateMap<ConversationWithTotalUnseenWithContactInfo, ConversationWithTotalUnseenWithContactInfoAndNoMessage>().ReverseMap();
        ...
        CreateMap<Conversation, NewDirectConversationModel_Conversation>().ReverseMap();
