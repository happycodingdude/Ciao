...
//     {
//         app.MapGroup(Constants.ApiGroup_Participant).MapGet("/{id}/check/{friendId}",
...
//         app.MapGroup(Constants.ApiGroup_Participant).MapGet("/{id}",
...
//         app.MapGroup(Constants.ApiGroup_Participant).MapPatch("/{id}",
