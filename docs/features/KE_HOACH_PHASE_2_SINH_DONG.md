...
> Phạm vi: các tính năng **chưa hoàn thành** của Phase 2. Mô tả ở mức nghiệp vụ.
...
| --- | --- | --- |
| Sticker | ⬜ | Bộ sticker + sticker yêu thích |
| GIF | ⬜ | Tìm kiếm và gửi GIF động |
| Tin nhắn thoại | ⬜ | Ghi âm, hiển thị dạng sóng, phát lại |
| Preview Link | ⬜ | Thumbnail + tiêu đề + mô tả cho liên kết |
| Bình chọn (Poll) | ⬜ | Tạo bình chọn trong hội thoại |
| Chia sẻ danh bạ | ⬜ | Gửi thẻ liên hệ |
| Dịch tin nhắn | ⬜ | Dịch nội dung tin nhắn |
...
| --- | --- | --- | --- | --- |
| **Đợt 1** | Sticker + GIF | Bản quyền/nguồn nội dung, dung lượng | Kho sticker/GIF | Ẩn bảng chọn sticker/GIF |
| **Đợt 2** | Tin nhắn thoại + Preview Link | Xử lý media nặng, tải nội dung ngoài | Lưu trữ media | Tắt ghi âm / tắt preview |
| **Đợt 3** | Bình chọn + Chia sẻ danh bạ | Quyền riêng tư (danh bạ) | Quyền thiết bị | Ẩn tùy chọn tương ứng |
| **Đợt 4** | Dịch tin nhắn | Chất lượng dịch, chi phí dịch vụ | Dịch vụ dịch | Ẩn nút dịch |
