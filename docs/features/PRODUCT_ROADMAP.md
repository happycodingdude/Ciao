...
|   5 | Đổi hình nền chat    | Wallpaper theo cuộc trò chuyện      | ⭐⭐⭐⭐☆  | ✅ Hoàn thành (nghiệm thu 2026-07-11, đủ rev 1→6): theme CHUNG cả hội thoại + sync realtime, leader-only trong nhóm ([chi tiết](./TUY_CHINH_DOAN_CHAT.md)) |
|   6 | Theme chat           | Đổi màu bong bóng chat              | ⭐⭐⭐⭐☆  | ✅ Hoàn thành (nghiệm thu 2026-07-11, đủ rev 1→6): preset AA-contrast + 3 chủ đề sự kiện, chung cả hội thoại ([chi tiết](./TUY_CHINH_DOAN_CHAT.md)) |
...
|   3 | Link mời            | Invite Link & QR Code | ⭐⭐⭐⭐☆  | ✅ Hoàn thành — nghiệm thu 2026-07-17 (gồm đợt fix + modal hoá preview); cải tiến giao diện link mời nghiệm thu bổ sung 2026-07-23 — [`LINK_MOI_VA_YEU_CAU_THAM_GIA.md`](./LINK_MOI_VA_YEU_CAU_THAM_GIA.md) |
...
|   8 | Rời nhóm            | Leave Group           | ⭐⭐⭐⭐☆  | ✅ Hoàn thành — nghiệm thu 2026-07-23 — [`ROI_NHOM.md`](./ROI_NHOM.md) |
